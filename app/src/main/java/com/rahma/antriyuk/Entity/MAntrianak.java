...
public class MAntrianak {
    ...
    @Expose
    private Integer id;
    @SerializedName("data_pasiens_id")
    @Expose
    private Integer dataPasiensId;
    ...
    public Integer getDataPasiensId() {
        return dataPasiensId;
    }

    public void setDataPasiensId(Integer dataPasiensId) {
        this.dataPasiensId = dataPasiensId;
    }
