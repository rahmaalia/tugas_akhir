...
public class MAntrimata {
    ...
    @Expose
    private Integer id;
    @SerializedName("data_pasien_matas_id")
    @Expose
    private Integer dataPasienMatasId;
    ...
    public Integer getDataPasienMatasId() {
        return dataPasienMatasId;
    }

    public void setDataPasienMatasId(Integer dataPasienMatasId) {
        this.dataPasienMatasId = dataPasienMatasId;
    }
