...
public class MAntriumum {
    ...
    @Expose
    private Integer id;
    @SerializedName("data_pasien_umums_id")
    @Expose
    private Integer dataPasienUmumsId;
    ...
    public Integer getDataPasienUmumsId() {
        return dataPasienUmumsId;
    }

    public void setDataPasienUmumsId(Integer dataPasienUmumsId) {
        this.dataPasienUmumsId = dataPasienUmumsId;
    }
